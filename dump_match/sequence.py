...
class Sequence(object):
    ...
    def make_xy(self, ii, jj):
        ...
        # load image path
        img_path_i = str(loadh5(image_i + '.' + self.desc_name + '.hdf5')["img_path"])[3:-2]
        img_path_j = str(loadh5(image_j + '.' + self.desc_name + '.hdf5')["img_path"])[3:-2]
        pairimage_path = img_path_i + '|' + img_path_j
        ...
        return xs, ys, dR, dt, ratio_test, mutual_nearest, cx1, cy1, f1, cx2, cy2, f2, pairimage_path
