...
if __name__ == "__main__":
    ...
    sun3d_te = Dataset(config.raw_data_path+'sun3d_test/', config.dump_dir, 'sun3d-'+config.desc_name+'-test.hdf5',
                       test_seqs, 'test', config.desc_name, config.vis_th, 1000, config.raw_data_path+'pairs/')
    ...
    sun3d_tr_va = Dataset(config.raw_data_path + 'sun3d_train/', config.dump_dir,
                          'sun3d-' + config.desc_name + '-val.hdf5',
                          train_seqs, 'val', config.desc_name, config.vis_th, 100, None)
    sun3d_tr_tr = Dataset(config.raw_data_path + 'sun3d_train/', config.dump_dir,
                          'sun3d-' + config.desc_name + '-train.hdf5',
                          train_seqs, 'train', config.desc_name, config.vis_th, 10000, None)